...
export default function StudentEntryClient({
  initialToken,
  initialEmail,
  initialError,
}: StudentEntryClientProps) {
  ...
  const [isPortalClosed, setIsPortalClosed] = useState(initialError === 'Portal Closed');
